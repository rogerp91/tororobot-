...
public class DevicesActivity extends BluetoothActivity implements DiscoveredDialogFragment.DiscoveredDialogListener {
...
//        sendBroadcast(new Intent().setAction("com.tororobot.action.UP"));
